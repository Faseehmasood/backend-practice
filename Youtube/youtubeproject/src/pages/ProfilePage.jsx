...
const ProfilePage = () => {
    ...
    const { data: statsData } = useGetChannelStatsQuery(undefined, {
        skip: !isAuthenticated
    })
    const { data: videosData } = useGetChannelVideosQuery(undefined, {
        skip: !isAuthenticated
    })
        ...
        <div className="min-h-screen bg-gray-950">
            ...
            <div className="w-full h-48 bg-gray-800">
                {profile?.coverImage ? (
                    ...
                    <div className="w-full h-full linear-gradient-to-r from-gray-800 to-gray-700" />
                )}
            </div>
                ...
                <div className="flex items-end justify-between -mt-12 mb-6">
                    ...
                    {isAuthenticated && userId !== user?._id && (
                        <button
                            ...
                            className="bg-red-500 hover:bg-red-600 text-white px-6 py-2 rounded-full transition-colors mb-2"
                        >
                            Subscribe
                        </button>
                    )}
                ...
                <div className="mb-6">
                    ...
                    {stats && (
                        <div className="flex gap-6 mt-2">
                            ...
                            <p className="text-gray-400 text-sm">
                                <span className="text-white font-semibold">{stats.totalLikes}</span> likes
                            </p>
                        </div>
                    )}
                </div>
